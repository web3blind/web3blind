...
- [HIP-4 Trading Bot](https://github.com/web3blind/hip-4-trading-bot) — Telegram trading bot for HyperLiquid HIP-4 prediction markets and market automation.
- [Accessibility Auditor](https://github.com/web3blind/accessibility-auditor) — includes a Telegram bot interface for website accessibility audits.

## Audio and creative tools

- [ActVoice](https://github.com/web3blind/actvoice) — accessible-first audio drama production service with REST/MCP control, RHVoice and Edge TTS support, Openverse sound effects, and server-side rendering.
- [Hermes Audio Drama](https://github.com/web3blind/hermes-audio-drama) — blind-first creative tooling for multi-voice audio storytelling with Hermes Agent, timed sound cues, and final audio export.

## Web3 and blockchain experiments

- [Viz Magic](https://github.com/web3blind/viz-magic) — decentralized browser RPG dApp running on the VIZ blockchain.
- [VibingDAO](https://github.com/web3blind/vibingdao) — Bitcoin L1 governance DAO on OPNet for the Vibecoding Challenge.
- [HIP-4 Trading Bot](https://github.com/web3blind/hip-4-trading-bot) — Web3 prediction-market trading automation from Telegram.
- [OG Accessibility Checker](https://github.com/web3blind/og-accessibility-checker) — accessibility analysis with verifiable TEE inference and on-chain proof.

## Other tools

- [Books Selection](https://github.com/web3blind/books-selection) — local tool for browsing FB2 book folders by annotations before choosing what to read.
...
If you find an accessibility issue in one of my projects, please open an issue. I especially care about problems that affect screen reader users, keyboard navigation, copyable text, forms, generated reports, and documentation structure.
